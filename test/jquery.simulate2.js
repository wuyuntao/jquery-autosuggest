...
(function ($) {
  ...
  $.simulate2 = (function(){
     ...
     */
    function triggerKeyEventsForString(field, str, keyTiming, triggerFocus, onComplete) {
      if (field && str) {
        field = $(field);
    ...
    return {
      triggerKeyEventsForString : triggerKeyEventsForString,
      triggerKeyEvents : triggerKeyEvents
    };
  }());
